...
* Changelog: Driver Fetches the corresponding HEX value to be fed from a array to map it.
*/
...
*/
	...
	unsigned int number_map[10] = { 63,6,91,79,102,109,125, 7,127, 103 }; // Write the corresponding value to 7-Segment memory address.
